...
//		private static final String SERVER_IP = "92.243.4.78";
		...
		public SendOSC(Map<String, Object> payload, OSCApi.Handler handler) {
			mPayload = payload;
			mHandler = handler;
		}
...
//				bundle.addPacket(msg);
		...
		public static SendOSC of(Map<String, Object> payload, OSCApi.Handler handler) {
