...
public class MapListActivity extends ListActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.list_view_rp);

        Button foot = (Button) findViewById(R.id.footer);
        ...
        foot.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MapListActivity.this, NewMapActivity.class));
            }
        });
...
//		filter.addTextChangedListener(this);
	...
	public boolean onContextItemSelected(MenuItem item) {
        ...
        if(id == R.id.menu_show_locations) {
